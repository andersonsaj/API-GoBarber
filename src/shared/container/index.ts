...
import NoticationsRepository from '@modules/notifications/infra/typeorm/repositories/NotificationsRepository';
...
container.registerSingleton<INotficationsRepository>(
  'NotificationsRepository',
  NoticationsRepository,
);
